...
export const members: Member[] = [
  ...
  },
  {
    ...
    affiliation: 'NYU Applied Psych / CESED Uniandes',
  ...
  {
    id: '8',
    name: 'Juan Camilo Cristancho',
    role: 'Candidato a PhD',
    affiliation: 'Universidad de California, Irvine',
  ...
  {
    id: '11',
    name: 'Hernando Grueso',
    role: 'Investigador / Fundador',
    affiliation: 'University of Oxford / AImpact Lab',
  ...
  {
    id: '14',
    name: 'Catalina Rey-Guerra',
    role: 'Investigadora',
    affiliation: 'Fundación Apapacho',
    location: 'Bogotá, Colombia',
